...
enum RouterVersion {
  ZENONRouter01 = 'ZENONRouter01',
  ZENONRouter02 = 'ZENONRouter02'
}

describe('ZENONRouter{01,02}', () => {
  for (const routerVersion of Object.keys(RouterVersion)) {
    ...
    beforeEach(async function() {
      ...
      router = {
        [RouterVersion.ZENONRouter01]: fixture.router01,
        [RouterVersion.ZENONRouter02]: fixture.router02
      ...
      describe('swapExactTokensForTokens', () => {
        ...
        it('gas', async () => {
          ...
          expect(receipt.gasUsed).to.eq(
            {
              [RouterVersion.ZENONRouter01]: 102328,
              [RouterVersion.ZENONRouter02]: 102338
            }[routerVersion as RouterVersion]
          )
        }).retries(3)
      })
